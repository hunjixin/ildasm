...
var _electron = __webpack_require__(50);

var _path = __webpack_require__(217);
...
var _MenuTemplate = __webpack_require__(219);
...
_electron.app.on('ready', function () {
  createWindow();
  var menu = _electron.Menu.buildFromTemplate((0, _MenuTemplate.CreateMenu)(_config2.default));
...
function createWindow() {
  ...
  _config2.default.emitManager.BindMenuEvent(mainWindow);
...
var _emitManager = __webpack_require__(84);
...
var Config = {
  ...
  title: 'ildasm',
  icon: 'images/sd.icon',
  emitManager: new _emitManager.EmitManager()
};
...
var EmitManager = function () {
  ...
  _createClass(EmitManager, [{
    key: 'BindMenuEvent',
    value: function BindMenuEvent(win) {
      var _this = this;

      this.windows = win;
      this.emitter.on('openFile', function (path) {
        _this._openFile(path);
      });
    }
  }, {
    key: 'Trigger',
    value: function Trigger(eventName) {
      ...
      (_emitter = this.emitter).emit.apply(_emitter, [eventName].concat(args));
    }
  }, {
    key: '_openFile',
    ...
    key: 'AddRenderListenner',
    value: function AddRenderListenner(eventName, callback) {
      __webpack_require__(50).ipcRenderer.on(eventName, callback);
    }
  }]);
